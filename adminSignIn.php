...
if ( ! empty( $_POST ) ) {
	...
	$sql = "SELECT * FROM admin_login WHERE username = '". $_POST['username'] ."';";
...
<!DOCTYPE html>
      ...
      <head>
        <meta charset="utf-8">
          ...
          <body>
                ...
                <h3><font color = "red">Admin Sign In</h3></font>
  ...
  <label class="sr-only" for="password"></label>
        <input id="password" name="password" size="20" type="password" class="form-control" placeholder="Password" tabindex="1">
    </div>
    <br>
    <div class="form-group">
  <input type="submit" value="Sign In" class="btn btn-default hidden-xs" tabindex="3"></form>    </div>
  <h4><font color = "red">Note : If you are a student, please use the Student Sign In page</h4></font>
  <div class="form-group">
